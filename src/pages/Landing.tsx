  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      ...
      <main className="container py-16 md:py-24">
        ...
        <section className="mt-24 grid gap-6 max-w-5xl mx-auto md:grid-cols-3">
          {topFeatures.map((f) => (
            <div key={f.title} className="p-6 rounded-2xl bg-card border border-border/60 shadow-soft hover:shadow-elegant transition-shadow">
        ...
        <section className="mt-6 grid gap-6 max-w-5xl mx-auto md:grid-cols-2">
          {bottomFeatures.map((f) => (
            <div
              key={f.title}
              className="p-6 rounded-2xl bg-card border border-border/60 shadow-soft hover:shadow-elegant transition-shadow"
            >
              <div className="h-10 w-10 rounded-xl bg-secondary flex items-center justify-center mb-4">
                <f.icon className="h-5 w-5 text-primary" />
              </div>
